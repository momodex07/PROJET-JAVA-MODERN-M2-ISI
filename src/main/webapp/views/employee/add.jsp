...
<div class="container-fluid py-4 px-4">
    ...
    <div class="form-header d-flex justify-content-between align-items-center">
        <div>
            <h1 class="fs-2 fw-bold mb-0"><i class="bi bi-person-plus-fill me-2"></i>Ajouter un Employé</h1>
            <p class="text-muted mb-0">Créez un nouvel employé dans le système</p>
        </div>
        <div class="quick-actions">
            <a href="${pageContext.request.contextPath}/employees" class="btn btn-outline-secondary"><i class="bi bi-arrow-left me-2"></i>Retour à la liste</a>
        </div>
    </div>
                ...
                <form action="${pageContext.request.contextPath}/employee/add" method="post">
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="nom" name="nom" required placeholder="Entrez le nom de famille">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="mb-3 mt-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control" id="email" name="email" required placeholder="exemple@entreprise.com">
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-circle me-2"></i>Ajouter l'employé
                        </button>
                    </div>
                </form>
            </div>
